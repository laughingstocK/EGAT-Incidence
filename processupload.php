...
$destination_folder = $_SERVER['DOCUMENT_ROOT'] . "/FR-HY-2001/uploads/"; //upload directory ends with / (slash)
...
if (isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    ...
    if ($image_res) {
        ...
        $new_file_name = $image_name_only . '_' . rand(0, 5000) . '.' . $image_extension;
